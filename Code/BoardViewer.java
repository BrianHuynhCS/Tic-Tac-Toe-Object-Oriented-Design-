...
public abstract class BoardViewer extends JPanel implements Observer, BoardStrategy {
	...
	public void winningState() {
		if (frame.isEnabled()) {
			...
			// checks board pattern and determine if player 1 or 2 wins.
			if (((x1 && x2 && x3) || (x4 && x5 && x6) || (x7 && x8 && x9) || (x1 && x4 && x7) || (x2 && x5 && x8)
					|| (x3 && x6 && x9) || (x1 && x5 && x9) || (x3 && x5 && x7))) {

				disableFrame();
				xWinner = true; // Indicates that player 1 won the game

			} else if (((o1 && o2 && o3) || (o4 && o5 && o6) || (o7 && o8 && o9) || (o1 && o4 && o7) || (o2 && o5 && o8)
					|| (o3 && o6 && o9) || (o1 && o5 && o9) || (o3 && o5 && o7))) {
				disableFrame();
